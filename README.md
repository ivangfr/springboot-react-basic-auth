...
- **Spring Boot module** (`book-api`): Code is formatted using [Spotless](https://github.com/diffplug/spotless) with [Google Java Format](https://github.com/google/google-java-format).
